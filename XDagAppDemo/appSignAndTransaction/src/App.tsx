...
const App = () => {
	...
	const [ pageName, setPageName ] = useState<string>( 'walletApi' );
	return (
		<>
						...
						<ul className="flex sm:flex-col overflow-hidden content-center justify-between">
							...
							<li className="py-2 hover:bg-indigo-300 rounded">
								<a className="truncate" href="#" onClick={ () => {setPageName( 'privacy' )} }>
									...
									<span className="hidden sm:inline">Another Page</span>
								</a>
							</li>
				...
				<main role="main" className="w-full h-full flex-grow p-3 overflow-auto">
					{
						(() => {
							...
							} else if ( pageName === 'walletApi' ) {
								return <WalletApi></WalletApi>;
							} else {
								return <></>;
							}
						})()
