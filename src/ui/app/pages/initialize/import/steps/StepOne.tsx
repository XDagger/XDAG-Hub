    ...
    >
      {({
        ...
        <Form className="flex flex-col flex-nowrap items-stretch flex-1 flex-grow justify-between">
          <FieldLabel txt={t("StepOne.EnterYourRecoveryPhrase")}>
                    ...
                    <PasswordInputField
                      ...
                      onPaste={async (e) => {
                        ...
                        if (words.length > 1) {
                          e.preventDefault();
                          const pasteIndex =
                            words.length === mnemonic.length ? 0 : index;
                          const newMnemonic = [...mnemonic];
                          const wordsToPaste = words.slice(
                            0,
                            mnemonic.length - pasteIndex,
                          );
                          newMnemonic.splice(
                            pasteIndex,
                            wordsToPaste.length,
          ...
          <div className="bg-xdag-lightest flex flex-col flex-nowrap items-stretch gap-2.5 sticky -bottom-7.5 px-7.5 pb-7.5 pt-4.5 -mx-7.5 -mb-7.5">
            ...
            <Button
              ...
              text={mode === "forgot" ? t("StepOne.Next") : t("StepOne.Continue")}
              after={<ArrowRight16 />}
            />
          </div>
        </Form>
