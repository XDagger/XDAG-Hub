  ...
  ],
  {
    variants: {
      ...
      dark: {
        ...
        false:
          "border-xdag-light text-hero-dark active:bg-gray-45 active:text-steel-darker active:border-gray-45 disabled:bg-white hover:bg-xdag-light focus:bg-xdag-light",
      },
    },
    defaultVariants: {
      dark: false,
