    ...
    variants: {
      variant: {
        ...
        secondaryXdag: [
          ...
          "hover:bg-xdag-light focus:bg-xdag-light",
          "visited:text-steel-darker",
          "active:text-steel-dark/70",
          "disabled:bg-gray-40 disabled:text-steel/50",
        ],
        ...
        hidden: [
          "bg-gray-45 bg-opacity-25 text-gray-60 hover:text-xdag-dark hover:bg-gray-35 hover:bg-opacity-75 border-none h-full w-full backdrop-blur-md",
        ],
      },
      size: {
...
const iconStyles = cva("flex", {
  variants: {
    variant: {
      primary: [
        "text-xdag-light group-active:text-steel/70 group-disabled:text-steel/50",
      ],
      secondary: [
        "text-steel",
