...
const styles = cva(
  [
    ...
    "hover:text-hero hover:bg-xdag-light hover:border-Xdag",
    "focus:text-hero focus:bg-xdag-light focus:border-Xdag",
...
>(({ bgOnHover, iconBefore, iconAfter, text, truncate, ...rest }, ref) => {
  return (
    <button {...rest} ref={ref} className={styles({ bgOnHover })}>
      ...
      <div className={clsx("overflow-hidden", truncate && "truncate")}>
        {text}
      </div>
      <div
        className={cx(
